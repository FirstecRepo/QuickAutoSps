...
QuickAutoSps는 무기체계 소프트웨어 개발 시 방위사업청에서 요구하는 소프트웨어 산출물 명세서(Software Product Specification)의 실행파일 목록 및 원본(소스)파일 목록을 자동으로 빠르게 생성해 주는 솔루션입니다. 소프트웨어 산출물 명세서 양식은 /Doc/SPS_format.hwp 파일에서 확인할 수 있습니다. QuickAutoSps는 해당 양식의 표10 실행파일 목록 및 표12 원본(소스) 목록을 양식에 맞게 자동으로 생성해 줍니다. 

## 프로젝트가 해결하려는 문제점
QuickAutoSps 프로젝트는 다음과 같은 문제점들을 해결하고자 합니다. 
...
-  산출물 목록 테이블 작성 작업은 기계적인 작업이 단순 반복됨으로 개발자의 사기를 저하시키고 다른 개발 업무에 부정적인 영향을 미칩니다.
- 산출물 목록 테이블 작성 시 사용자의 실수가 잦고 실수를 찾기가 매우 어렵습니다.
 
## 프로젝트의 비전 
QuickAutoSps 프로젝트는 다음과 같은 비전을 가지고 시작되었습니다. 

- 개발자의 시간과 에너지 절약하여 보다 의미 있는 곳에 활용할 수 있도록 합니다.
  
- 단순 반복 작업에서 오는 정신적 스트레스을 제거합니다.

- 수작업에서 오는 사용자 실수 제거하여 산출물의 질을 향상 시킵니다.
